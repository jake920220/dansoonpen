...
const state = (settings = DEFAULT_SETTINGS): AppState => ({ feedback: null, clearUndoToken: null, brushGeneration: 0, cursorEnabled: false, annotationsVisible: true, settings, brush: defaultBrush(settings), mode: 'interact', activeDisplayId: null, revision: 1, error: null, displays: [] });
