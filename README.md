...
설정창의 색상·굵기·글자 크기는 시작 기본값으로 자동 저장되고 현재 도구에도 적용됩니다. 도구막대에서 바꾼 색상·굵기는 실행 중인 현재 도구에만 적용하며 시작 기본값을 덮어쓰지 않습니다. 앱 재시작 시에는 시작 기본 펜을 사용합니다. 애니메이션 설정도 자동 저장됩니다. 이미 그린 내용은 바뀌지 않습니다. 기본 색상은 노란색 `#ffcf56`이며 6색 구성은 유지합니다. 원형 색상을 누르면 현재 펜 색상을 바꾸고, 무지개 버튼을 누르면 색상환이 열립니다. 색상환의 방향키 좌우는 색조, 상하는 채도를 조절합니다. 밝기·HEX 입력과 ‘빠른 색상 N에 저장’도 사용할 수 있습니다.
