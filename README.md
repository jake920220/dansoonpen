...
| 전체 지우기 | Option+Shift+X | Alt+Shift+X |
| 그림을 유지하고 앱 조작 | Esc | Esc |
| 실행 취소 / 다시 실행 | Cmd+Z / Cmd+Shift+Z | Ctrl+Z / Ctrl+Shift+Z |
| 펜 / 지우개 / 텍스트 | P / E / T | P / E / T |
| 빠른 색 / 굵기 | 1–6 / [ ] | 1–6 / [ ] |

텍스트 편집 중에는 도구 문자키가 입력을 가로채지 않습니다. Enter는 입력 완료, Shift+Enter는 줄바꿈, Esc는 편집 취소입니다. 한글 조합 중에는 조합 처리를 우선합니다. 단축키는 설정 화면에서 바꿀 수 있습니다.
