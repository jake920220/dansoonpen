...
도구막대 왼쪽 손잡이를 드래그하면 이동합니다. 키보드로 손잡이에 초점을 맞춘 후 방향키(10px)·Shift+방향키(40px)로 옮기고 Home 또는 손잡이 두 번 클릭으로 상단 중앙에 돌려놓을 수 있습니다. 오른쪽 버튼으로 접고 펼칩니다. 위치와 접힌 상태는 화면별로 기억합니다.
